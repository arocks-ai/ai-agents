...
async def main():
    ...
    # skill_file = ROOT / "dev_assistant_app" / "skills" / "generated" / "dockerfile-creation" / "SKILL.md"

    skill_content = skill_file.read_text(encoding="utf-8")
    
    user_message = "What is the branching strategy and when should I rebase instead of merge?"
    # user_message = "How to create docker file?"   # Docker skill be created first before response to this query
